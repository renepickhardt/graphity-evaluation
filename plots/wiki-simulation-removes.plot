...
outfile="wiki-simulation-removes"

################ label ################
set key top right
#set title 'GRAPHITY over Stou ratio'
set xlabel 'Wiki dump year'
set ylabel 'Removed follow edges per second'
...
plot 	graphity using ($1-0.1):($10):(0.3) with boxes title "GRAPHITY" ls 1 lw 2 fs pattern 2, \
	stou using ($1+0.1):($10):(0.3) with boxes title "STOU" ls 3 lw 2 fs pattern 4
